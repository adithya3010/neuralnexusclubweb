                ...
                <div className="grid md:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2 text-muted-foreground text-sm">
                            ...
                            <span>neuroversecbit@gmail.com</span>
                        </div>
                        <div className="flex space-x-4 pt-2">
                            {/* Socials Placeholder */}
                            <a href="https://www.instagram.com/neuroverse_2k26" className="h-8 w-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-white/60 hover:text-white">
                            ...
                            <a href="https://www.linkedin.com/company/neuroverse-cbit/" className="h-8 w-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-white/60 hover:text-white">
